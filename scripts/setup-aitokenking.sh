#!/usr/bin/env bash
# Open MCP Server Network —— AI Token King 全域設定
#
# 遷自 firekou/aitokenking_mediahouse（commit cf91493）的 scripts/setup-aitokenking.sh，
# 邏輯逐字未改 —— 它已在該 repo 驗證過，改寫只會製造新的除錯成本。
#
# 寫兩個檔案，缺一不可：
